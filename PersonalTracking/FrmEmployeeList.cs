...
namespace PersonalTracking
{
    public partial class FrmEmployeeList : Form
    {
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            detail.BhirhtDay = Convert.ToDateTime(dataGridView1.Rows[e.RowIndex].Cells[13].Value);
        ...
        {
            DialogResult result = MessageBox.Show("Are you sure to delete this emploee?", "Warning", MessageBoxButtons.YesNo);
